    ...
    <div className="bg-background text-foreground">
      <div className="container max-w-4xl py-12 md:py-16 lg:py-20">
        <div className="text-center mb-12">
          <Truck className="mx-auto h-12 w-12 md:h-16 md:w-16 text-primary mb-4" />
        ...
        <div className="prose prose-md md:prose-lg dark:prose-invert mx-auto max-w-full space-y-6">
          <h2 className="text-xl md:text-2xl">How Shipping Works</h2>
          <p>
          ...
          <h2 className="text-xl md:text-2xl">Shipping Costs & Times</h2>
          <p>
          ...
          <h2 className="text-xl md:text-2xl">Order Tracking</h2>
          <p>
          ...
          <h2 className="text-xl md:text-2xl">International Shipping</h2>
          <p>
           ...
           <h2 className="text-xl md:text-2xl">Questions About Your Shipment?</h2>
          <p>
