...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-border/40 bg-background/95 py-12">
      <div className="container grid max-w-7xl grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-4">
        <div className="flex flex-col gap-4 items-start md:col-span-1">
          ...
          <div className="flex gap-1">
            <Button variant="ghost" size="icon" asChild>
                <Link href="#">
                    <FaTiktok className="h-5 w-5 transition-colors hover:text-primary" />
        ...
        <div className="grid grid-cols-2 gap-8 md:col-span-2 md:grid-cols-3">
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/#new-arrivals" className="text-sm text-foreground/60 hover:text-primary transition-colors">New Arrivals</Link></li>
              <li><Link href="/#women" className="text-sm text-foreground/60 hover:text-primary transition-colors">Women</Link></li>
              <li><Link href="/#men" className="text-sm text-foreground/60 hover:text-primary transition-colors">Men</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/blog" className="text-sm text-foreground/60 hover:text-primary transition-colors">Blog</Link></li>
              <li><Link href="/sustainability" className="text-sm text-foreground/60 hover:text-primary transition-colors">Sustainability</Link></li>
              <li><Link href="/careers" className="text-sm text-foreground/60 hover:text-primary transition-colors">Careers</Link></li>
              <li><Link href="/press" className="text-sm text-foreground/60 hover:text-primary transition-colors">Press</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/shipping" className="text-sm text-foreground/60 hover:text-primary transition-colors">Shipping</Link></li>
              <li><Link href="/returns" className="text-sm text-foreground/60 hover:text-primary transition-colors">Returns</Link></li>
            </ul>
          </div>
        </div>
      ...
      <div className="container max-w-7xl mt-12 pt-8 border-t border-border/40 text-center text-sm text-foreground/60">
        <p>&copy; {new Date().getFullYear()} Love Clothes & Shoes. All rights reserved.</p>
        <p>Built by <a href="https://www.synctech.ie" target="_blank" rel="noopener noreferrer" className="hover:text-primary font-semibold underline">SYNC TECH</a></p>
      </div>
    </footer>
  );
}
